...
%Author: Eric Bowers and Danial Zielenki 
%Date:4/14/2014
...
handles.video = videoinput('winvideo',2);%video format and id.
...
imwrite(F.cdata, fullfile('C:\Users\Eric\Google Drive\Project 3134\FinalProject','GreenAxe2.jpg'));
    hold off
...
imwrite(F.cdata, fullfile('C:\Users\Eric\Google Drive\Project 3134\FinalProject','RedAxe2.jpg'));
...
imwrite(F.cdata, fullfile('C:\Users\Eric\Google Drive\Project 3134\FinalProject','BlueAxe2.jpg'));
end
